...
if (isset($_POST['bcari'])) {
    ...
    $keyword = $_POST['tcari'];
    $q = "SELECT * FROM tagihan WHERE id_hewan LIKE '%$keyword%' OR nama_hewan LIKE '%$keyword%' 
...
<body>
  ...
  <div class="p-4" id="main-content">
    ...
    <div class="container-fluid">
      ...
      <a href="kelolatagihan.php" type="button" class="btn btn-primary mb-3">Tambah Data <i class="fa fa-plus"></i></a>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td><center><?php echo $result['tgl_jatuhtempo']; ?></center></td>
                ...
                <td>
                  ...
                  <a href="kelolatagihan.php?ubah=<?php echo $result['id_hewan']; ?>" type="button" class="btn btn-success btn-sm"> 
